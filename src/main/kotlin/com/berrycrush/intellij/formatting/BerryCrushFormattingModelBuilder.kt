...
class BerryCrushFormattingModelBuilder : FormattingModelBuilder {
     ...
     */
    private fun createSpacingBuilder(settings: CodeStyleSettings): SpacingBuilder = SpacingBuilder(settings, BerryCrushLanguage)
        // Space after colon in keywords
        .after(BerryCrushTokenTypes.COLON)
        .spaces(1)
        // No space before colon
        .before(BerryCrushTokenTypes.COLON)
        .spaces(0)
        // Space after step keywords
        .after(BerryCrushTokenTypes.GIVEN)
        .spaces(1)
        .after(BerryCrushTokenTypes.WHEN)
        .spaces(1)
        .after(BerryCrushTokenTypes.THEN)
        .spaces(1)
        .after(BerryCrushTokenTypes.AND)
        .spaces(1)
        .after(BerryCrushTokenTypes.BUT)
        .spaces(1)
        // Space after directives
        .after(BerryCrushTokenTypes.CALL)
        .spaces(1)
        .after(BerryCrushTokenTypes.ASSERT)
        .spaces(1)
        .after(BerryCrushTokenTypes.INCLUDE)
        .spaces(1)
}
