...
object BerryCrushHighlightingColors {
    ...
    @JvmField
    val BLOCK_KEYWORD: TextAttributesKey =
    ...
    @JvmField
    val STEP_KEYWORD: TextAttributesKey =
        createTextAttributesKey(
    ...
    @JvmField
    val ASSERTION_KEYWORD: TextAttributesKey =
        createTextAttributesKey(
    ...
    @JvmField
    val OPERATION_REF: TextAttributesKey =
        createTextAttributesKey(
    ...
    // JSON path ($.)
    @JvmField
    val JSON_PATH: TextAttributesKey =
        createTextAttributesKey(
