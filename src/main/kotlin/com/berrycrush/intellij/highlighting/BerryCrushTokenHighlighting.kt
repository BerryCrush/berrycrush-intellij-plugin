...
object BerryCrushTokenHighlighting {
    ...
    private val keyByToken: Map<IElementType, TextAttributesKey> = buildMap {
        listOf(
    ...
    fun keyForToken(tokenType: IElementType?): TextAttributesKey? =
        tokenType?.let { keyByToken[it] }

    fun keysForToken(tokenType: IElementType?): Array<TextAttributesKey> =
        tokenType?.let { keysByToken[it] } ?: emptyKeys
}
