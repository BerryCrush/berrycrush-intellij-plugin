package org.berrycrush.intellij.refactoring.safedelete
...
class SafeDeleteTest : BerryCrushTestCase() {
    ...
    fun testFragmentElementContainsNestedSteps() {
        ...
        val nestedSteps = PsiTreeUtil.findChildrenOfType(fragmentElement, org.berrycrush.intellij.psi.BerryCrushStepElement::class.java)
